    ...
    <div className="min-h-screen font-[family-name:var(--font-noto-sans-kr)]" style={{ background: "#0a0a0a" }}>
      ...
      <main className="w-full px-0 py-0">
        ...
        {lastUpdate && (
          <div className="mb-1 flex items-center justify-between px-1 py-0.5">
            ...
            <button
              ...
              className="text-[10px] bg-gray-800 text-gray-400 px-2 py-0.5 rounded hover:bg-gray-700 transition-colors"
            >
        ...
        <div className="flex gap-0 h-[calc(100vh-80px)]">
          ...
          {/* Main feed */}
          <div className="min-w-0 flex-1 px-3 py-1 overflow-y-auto">
            {/* Channel sidebar toggle */}
            <button
              onClick={() => setChannelSidebarOpen(v => !v)}
              className="hidden md:flex items-center gap-1 px-2 py-1 text-[10px] text-[#555] hover:text-white transition-colors"
            >
