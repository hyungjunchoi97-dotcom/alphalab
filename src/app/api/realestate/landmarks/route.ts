...
const LANDMARKS: { district: string; code: string; keywords: KeywordRule[] }[] = [
  ...
  { district: "마포구", code: "11440", keywords: ["마포래미안푸르지오", "마포그랑자이", "한강밤섬자이", "마포현대", "공덕자이", { include: "신촌숲", label: "신촌숲아이파크" }, { include: "염리삼성", label: "염리삼성래미안" }] },
  { district: "강동구", code: "11740", keywords: ["고덕그라시움", "고덕아르테온", "고덕숲아이파크", "강동헤리티지자이", "래미안솔베뉴", { include: "고덕센트럴", label: "고덕센트럴IPARK" }, { include: "롯데캐슬", label: "강동롯데캐슬" }, { include: "천호", label: "천호현대" }, { include: "성내", label: "성내삼익" }] },
  ...
  { district: "중구", code: "11140", keywords: ["남산타운", { include: "신당", label: "신당동삼성" }, { include: "황학", label: "황학동벽산" }, { include: "을지", label: "을지한국" }] },
  // D티어
  { district: "서대문구", code: "11410", keywords: [{ include: "DMC파크뷰", label: "DMC파크뷰자이" }, { include: "홍제원", label: "홍제원현대" }, { include: "남가좌", label: "남가좌현대" }, { include: "북가좌", label: "북가좌삼호" }] },
  ...
  { district: "강북구", code: "11305", keywords: [{ include: "미아1차래미안", label: "미아래미안" }, { include: "래미안수유", label: "래미안수유" }, { include: "번동금호", label: "번동금호어울림" }, { include: "수유벽산", label: "수유벽산1차" }, { include: "수유역두산", label: "수유역두산위브" }] },
  { district: "도봉구", code: "11320", keywords: [{ include: "창동주공", label: "창동주공17단지" }, { include: "방학", label: "방학현대" }, { include: "도봉", label: "도봉현대" }, { include: "쌍문", label: "쌍문현대" }, { include: "방학동삼성", label: "방학동삼성래미안" }] },
];
