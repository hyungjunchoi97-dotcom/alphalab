...
// Indicator chart config (monochrome — labels only)
    ...
    >
      ...
      >
        <div className="px-5 pb-5 space-y-6" style={{ borderTop: `1px solid ${B.divider}` }}>
          {/* Indicator descriptions — 2-col grid */}
...
// ── Component ──────────────────────────────────────────────
export default function LiquidityNavPage() {
  const { lang } = useLang();
  ...
  // State — chart data (from /api/macro/fred)
  ...
  // ── Render ───────────────────────────────────────────────
  return (
    <div className="min-h-screen flex flex-col" style={{ background: B.bg, color: B.text }}>
      <AppHeader active="liquidityNav" />

      <div className="mx-auto max-w-[1200px] w-full px-4 py-6 space-y-8">
        {/* ── Page Header ─────────────────────────────────── */}
        ...
        {!loading && (
          <>
            {/* ═══════════════════════════════════════════════
                SECTION 1: FED LIQUIDITY DASHBOARD
                ═══════════════════════════════════════════════ */}
            <section>
              ...
              {/* PART 1: 2x2 Quad Chart Grid — Core Fed indicators */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              {/* ═════════════════════════════════════════════
                  SECTION 2: GLOBAL LIQUIDITY INDICATORS
                  ═════════════════════════════════════════════ */}
              <h2
