...
function priceTierColor(avgPrice: number): string {
  if (!avgPrice || avgPrice <= 0) return "#374151";
  const ok = avgPrice / 10000;
  if (ok < 10) return "#15803d";
  if (ok < 15) return "#16a34a";
  if (ok < 20) return "#ca8a04";
  if (ok < 25) return "#ea580c";
  return "#dc2626";
}
...
const LEGEND = [
  { color: "#dc2626", label: "25억+" },
  { color: "#ea580c", label: "20~25억" },
  { color: "#ca8a04", label: "15~20억" },
  { color: "#16a34a", label: "10~15억" },
  { color: "#15803d", label: "~10억" },
