...
export default function TopTickerBar() {
  ...
  return (
    <div className="group relative overflow-hidden border-b border-card-border/60 bg-background">
      <div style={{ ["--ticker-duration" as string]: "40s" }} className="ticker-scroll flex w-max items-center gap-6 whitespace-nowrap px-4 py-1.5 group-hover:[animation-play-state:paused]">
